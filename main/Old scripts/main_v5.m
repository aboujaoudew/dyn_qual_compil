...
function res = main_v5(ci,MMI_sign,vect_reac,kin,nb_val,model)
clc
...
cell2mat(trans_set_reg(20:40, [1 4 2 5]));
...
% 
% % Elimination of the (singular) transitions forbidden by the upwards crossing interval
% % constraint
